      ...
      <div id="slide">
        <div class="slider">
          <ul class="items">
            ...
            <li><img src="images/main3.jpg" alt=""></li>
          </ul>
        </div>
        ...
        <div class="clear"></div>
               <form action="regact.jsp" method="post" >
                   <center> <table>
					    ...
					    <tr>
                                                <center><td width="191" height="43"><font color="black">SELECT A DATE:</td>
                                                <td width="218"><input id="date" name="date" type="date" /></td></center>
                                            </tr><br>
 ...
 <tr style="color: black">
    ...
    %>
                        ...
                        <tr>
                          ...
                          <td><input type="text" id="num" name="guest" class="text" placeholder="Enter the no.of tables required" /></td>
                        </tr><br><br>
                        ...
                        <tr>
                          ...
                          <td><input type="text" id="time" name="time" class="text" placeholder="Time" /></td>
                        </tr><br><br>
                        <tr>
                          <td height="43"><font color="black">FIRST NAME  :</td>
                          <td><input id="fname" name="fname" class="text"  placeholder="FirstName"/></td>
                        </tr><br><br>
                        <tr>
                          <td height="43"><font color="black">LAST NAME  :</td>
                          <td><input id="lname" name="lname" class="text"  placeholder="LastName"/></td>
                        </tr><br><br>
                        
                        <tr>
                          <td height="43"><font color="black">EMAIL :</td>
                          <td><input id="email" name="email" class="text"  placeholder="abc@gmail.com"></input></td>
                        </tr><br><br>
                        <tr>
                          <td height="43"><font color="black">PHONE NUMBER :</td>
                          <td><input id="mobile" name="mobile" class="text"  placeholder="9030175322" /></td>
                        </tr><br><br>
                        <tr>
