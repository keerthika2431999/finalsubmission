        ...
        <div class="col-1">
          ...
          <div class="box-1">
            ...
            <div class="extra-wrap">
              <p class="it-bold p2">Valencia is one of Free Website Templates created by TemplateMonster.com team. This website template is optimized for 1280X1024 screen resolution. </p>
              <p class="border-1">The PSD source files of this Valencia<br>
                template are available for free for the<br>
                registered members of TemplateMonster.com. Feel free to get them! Vivamus hendrerit<br>
                mauris ut dui gravida ut viverra lectus <br>
                incidunt. </p>
              <a href="#" class="link-1">read more</a> </div>
          </div>
        </div>
        <div class="col-2 left-2">
          ...
          <div class="box-2 top-2">
            <div class="comment border-1">
              ...
              <span class="clr-1"><strong>Tina Smith</strong> <i>(top manager)</i></span> </div>
            <div class="comment border-1 top-3">
              <p><img src="images/comment-top.png" alt="" ><span class="clr-1">Vivamus hendrerit mauris ut dui</span> gravida ut viverra lectus incidunt. Cras mattis tempor eros nec tristique. Sed sed felis arcu, vel vehicula.<img src="images/comment-bottom.png" alt="" class="second"></p>
              <span class="clr-1"><strong>John Green</strong> <i>(director)</i></span> </div>
            <a href="#" class="link-1">read more</a> </div>
        </div>
        <div class="clear"></div>
        <div class="block-3">
          ...
          <div class="box-3">
            <div>
              ...
              <p class="border-2"><span class="it-bold clr-1">Vivamus hendrerit</span><br>
                mauris ut dui gravida ut rra lectus incidunt. Cras mattis tempor eros nec tristique. </p>
              <a href="#" class="link">read more</a> </div>
            <div>
              <div class="img-border"><img src="images/page1-img3.jpg" alt=""></div>
              <p class="border-2"><span class="it-bold clr-1">Cras mattis tempor eros nec </span><br>
                tristique Sed sed felis arcu, vel vehicula augue maecenas faucibus sagittis.</p>
              <a href="#" class="link">read more</a> </div>
            <div>
              <div class="img-border"><img src="images/page1-img4.jpg" alt=""></div>
              <p class="border-2"><span class="it-bold clr-1">Sed sed felis arcu, vel </span><br>
                vehicula augue maecenas faucibus sagittis cursus. Fusce tincidunt tellus eget.</p>
              <a href="#" class="link">read more</a> </div>
            <div class="last">
              <div class="img-border"><img src="images/page1-img5.jpg" alt=""></div>
              <p class="border-2"><span class="it-bold clr-1">Maecenas faucibus sagittis</span><br>
                cursus fusce tincidunt, tellus eget tristique cursus orci mi iaculis sem sit amet.</p>
              <a href="#" class="link">read more</a> </div>
          </div>
        </div>
      </div>
